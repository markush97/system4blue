...
@Component({
  ...
  template: `
  <s4b-entity-table [dataSource]="partnersService" [tableDefinition]="tableDefinition"></s4b-entity-table>
  `,
  styleUrls: ['./admin-partners-list.component.scss']
})
export class AdminPartnersListComponent {

  tableDefinition: EntityTableDefinition = {
    ...
    columns: [
      ...
      {field: 'contactPhone', label:'Telefon', sortAble: false, type: 'phone'}
    ]
  };
